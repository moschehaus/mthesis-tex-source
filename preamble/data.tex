...
\newcommand*{\StudyProgramme}{\textcolor{red}{Mathematical and Computational Modelling in Physics}}

%% Abstract (recommended length around 80-200 words; this is not a copy of your thesis assignment!)
\newcommand*{\Abstract}{%
  We adapt the density-independent SPH formulation to use potential temperature, and combine it with a novel well-balanced discretisation that preserves hydrostatic equilibrium at the discrete level. 
}
