...
%% FIX: zref-clever recognises the reference type from \refstepcounter, but titlesec
%%   runs \refstepcounter inside a group, so the \@currentcounter assignment is local
%%   and reverts once the group ends. For unnumbered levels, \refstepcounter is skipped
%%   entirely. In both cases, \label then inherits the type of the last globally stepped
%%   counter (e.g. sidenote). We fix this by globally setting \@currentcounter in the
%%   before-code of each \titleformat. For numbered levels, this is harmless (same value).
\makeatletter
\NewDocumentCommand{\fixzreftype}{m}{\gdef\@currentcounter{#1}}
\makeatother
...
\titleformat{\section}      {\fixzreftype{section}\MakeLinkTarget[section]{}\Large\sffamily\bfseries}{\thesection}{0.8em}{}
\titleformat{\subsection}   {\fixzreftype{subsection}\MakeLinkTarget[subsection]{}\large\sffamily\bfseries}{\thesubsection}{0.8em}{}
\titleformat{\subsubsection}{\fixzreftype{subsubsection}\MakeLinkTarget[subsubsection]{}\normalsize\sffamily\bfseries}{\thesubsubsection}{0.8em}{}
\titleformat{\paragraph}[runin]{\fixzreftype{paragraph}\MakeLinkTarget[paragraph]{}\normalsize\sffamily\bfseries}{\theparagraph}{0em}{}
